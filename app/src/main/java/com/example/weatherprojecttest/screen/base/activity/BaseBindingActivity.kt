package com.example.weatherprojecttest.screen.base.activity
...
abstract class BaseBindingActivity<V : ViewDataBinding, M : BaseViewModel> : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewDataBinding?.apply {//của ViewDataBinding
    ...
    @RequiresApi(Build.VERSION_CODES.LOLLIPOP) //thay đổi trạng thái của status bar
